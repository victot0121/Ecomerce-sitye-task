        ...
        <div className='mt-14 w-[100%] grid justify-center mb-5'>
           ...
           <div>
            ...
            <div className='grid grid-cols-4'>
                ...
                <div className='relative flex flex-col border border-gray-600 bg-[url("/assets/Main-product-list-4.jpg.png")] bg-cover bg-center'
                    style={{ width: '194px', height: '290px' }}
                >
                    <div className='bg- flex w-full gap-[118px] mt-3'>
                        <div className='flex w-full gap-[123px] mt-3'>
                ...
                <div className='relative flex flex-col border border-gray-600 bg-[url("/assets/Main-product-list-3.jpg.png")] bg-cover bg-center mb-3'
                    style={{ width: '194px', height: '290px' }}
                >
                    <div className='bg- flex w-full gap-[118px] mt-3'>
                        <div className='flex w-full gap-[123px] mt-3'>
